...
dictionary = {'а': 1, 'в': 1, 'е': 1, 'и': 1, 'н': 1, 'о': 1, 'р': 1, 'с': 1,
              'т': 1, 'д': 2, 'к': 2, 'л': 2, 'м': 2, 'п': 2, 'у': 2, 'б': 3,
              'г': 3, 'ё': 3, 'ь': 3, 'я': 3, 'й': 4, 'ы': 4, 'ж': 5, 'з': 5,
...
for i in range(0, len(word)):
    summa += dictionary[word[i]]

print(" Ваше слово \"", word, "\" приносит ", summa, " очков!")
